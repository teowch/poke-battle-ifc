...
class Battle
  ...
  nextTurn: (userMoveId) ->
    ...
    # Choose moves
    if pokemon1.choosenMove?
      pokemon1.chooseMove pokemon2, pokemon1.choosenMove
    else pokemon1.chooseMove pokemon2

    if pokemon2.choosenMove?
      pokemon2.chooseMove pokemon1, pokemon2.choosenMove
    else
    ...
    # console.log attacker.move if attacker.move?
    ...
    @allStats = []
    for pokemon in @trainer1.team
      @allStats.push(pokemon.ailment)
    for pokemon in @trainer2.team
      @allStats.push(pokemon.ailment)

    # console.log(pokemon2.ailment)

    # for ail in @allStats
    #   console.log(ail)
    # console.log(JSON.stringfy(ail))
    # return allStats
